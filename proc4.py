...
if __name__ == '__main__':
    ...
    Follows Procedure 3 using GPT with streaming
    Translations in batches of 9 (src language), splitting 90 pairs from Flores+ dataset into 10 batches each
    Number of Input sentences: 400, within acceptable range of 360-480 sentences
    '''
    main(parser=proc_parser(desc=desc), proc=Proc4())
